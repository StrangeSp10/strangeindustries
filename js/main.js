...
$('[id="menu-share"],[id="contact"]').on('click',function(){
    if($(this).attr('data-click-state') == 1) {
        $(this).attr('data-click-state', 0);
        $('li').children('a:only-of-type').css('visibility', 'hidden')
        $('li').children('a:only-of-type').removeClass('show_keyframe');
        $('li').children('a:only-of-type').addClass('hide_keyframe');
      }
    else {
      $(this).attr('data-click-state', 1);
      $('li').children('a:only-of-type').css('visibility', 'visible')
      $('li').children('a:only-of-type').removeClass('hide_keyframe');
      $('li').children('a:only-of-type').addClass('show_keyframe');
